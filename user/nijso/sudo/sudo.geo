...
N2 =225;
L1=16;
// number of points on the outer radius
L2=30;
...
//+
// square
Point(1) = {-1.2*Xs, -Xs, 0, 1.0};
Point(2) = {+1.2*Xs, -Xs, 0, 1.0};
Point(3) = {+Xs, +Xs, 0, 1.0};
Point(4) = {-Xs, +Xs, 0, 1.0};
...
Extrude {0, 0, -L_upstream} {
  Surface{3}; Surface{4}; Surface{6}; Surface{2}; Layers{{25,25,100},{0.1,0.25,1}}; Recombine;
}
// make the bend 
...
Extrude {L_downstream, 0, 0} {
  Surface{26}; Surface{30}; Surface{33}; Surface{36}; Layers{{25,25,100},{0.1,0.25,1}}; Recombine;
}
//+
